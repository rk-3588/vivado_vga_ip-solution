...
reg   [7:0] tmp_reg_509;
reg   [7:0] tmp_1_reg_514;
reg   [7:0] tmp_2_reg_519;
reg    ap_block_state8;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001) & (icmp_ln73_fu_408_p2 == 1'd0))) begin
        tmp_1_reg_514 <= {{ap_phi_mux_p_Val2_s_phi_fu_336_p4[15:8]}};
        tmp_2_reg_519 <= {{ap_phi_mux_p_Val2_s_phi_fu_336_p4[23:16]}};
...
assign icmp_ln73_fu_408_p2 = ((t_V_8_reg_296 == cols_V_reg_462) ? 1'b1 : 1'b0);

assign img_cols_V_out_din = img_cols_V_dout;

assign img_data_stream_0_V_din = tmp_reg_509;

assign img_data_stream_1_V_din = tmp_1_reg_514;

assign img_data_stream_2_V_din = tmp_2_reg_519;

assign img_rows_V_out_din = img_rows_V_dout;

assign j_V_fu_413_p2 = (t_V_8_reg_296 + 32'd1);

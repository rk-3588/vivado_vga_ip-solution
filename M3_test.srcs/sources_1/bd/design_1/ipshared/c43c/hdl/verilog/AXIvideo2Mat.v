...
reg   [7:0] tmp_reg_509;
reg   [7:0] tmp_2_reg_514;
reg   [7:0] tmp_3_reg_519;
reg    ap_block_state8;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln71_fu_397_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b1 == ap_condition_pp1_exit_iter0_state5))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln71_fu_397_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        axi_data_V_0_i_reg_253 <= tmp_data_V_reg_467;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b0 == ap_block_pp1_stage0_11001) & (icmp_ln73_reg_496 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if ((~((input_stream_TVALID_int == 1'b0) & (eol_2_i_reg_368 == 1'd0)) & (1'b1 == ap_CS_fsm_state8) & (eol_2_i_reg_368 == 1'd0))) begin
        axi_data_V_3_i_reg_356 <= input_stream_TDATA_int;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        axi_last_V_0_i_reg_243 <= tmp_last_V_reg_475;
    end else if ((1'b1 == ap_CS_fsm_state9)) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_200)) begin
        if (((or_ln76_fu_422_p2 == 1'd1) & (icmp_ln73_fu_408_p2 == 1'd0))) begin
            axi_last_V_2_i_reg_319 <= ap_phi_mux_eol_phi_fu_277_p4;
        end else if (((or_ln76_fu_422_p2 == 1'd0) & (icmp_ln73_fu_408_p2 == 1'd0))) begin
            axi_last_V_2_i_reg_319 <= input_stream_TLAST_int;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        ...
        axi_last_V_3_i_reg_344 <= input_stream_TLAST_int;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        ...
        eol_2_i_reg_368 <= input_stream_TLAST_int;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_200)) begin
        if (((or_ln76_fu_422_p2 == 1'd1) & (icmp_ln73_fu_408_p2 == 1'd0))) begin
            ...
            p_Val2_s_reg_332 <= input_stream_TDATA_int;
        end else if ((1'b1 == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001) & (icmp_ln73_fu_408_p2 == 1'd0))) begin
        sof_1_i_fu_172 <= 1'd0;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        icmp_ln73_reg_496 <= icmp_ln73_fu_408_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001) & (icmp_ln73_fu_408_p2 == 1'd0))) begin
        tmp_2_reg_514 <= {{ap_phi_mux_p_Val2_s_phi_fu_336_p4[15:8]}};
        tmp_3_reg_519 <= {{ap_phi_mux_p_Val2_s_phi_fu_336_p4[23:16]}};
        tmp_reg_509 <= tmp_fu_428_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((input_stream_TVALID_int == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
        tmp_data_V_reg_467 <= input_stream_TDATA_int;
        tmp_last_V_reg_475 <= input_stream_TLAST_int;
    end
end

always @ (*) begin
    if ((icmp_ln73_fu_408_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln71_fu_397_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp1_stage0) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (icmp_ln73_reg_496 == 1'd0))) begin
...
always @ (*) begin
    if ((icmp_ln73_fu_408_p2 == 1'd0)) begin
        if ((or_ln76_fu_422_p2 == 1'd1)) begin
            ap_phi_mux_p_Val2_s_phi_fu_336_p4 = ap_phi_mux_axi_data_V_1_i_phi_fu_288_p4;
        end else if ((or_ln76_fu_422_p2 == 1'd0)) begin
            ap_phi_mux_p_Val2_s_phi_fu_336_p4 = input_stream_TDATA_int;
        end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (or_ln76_fu_422_p2 == 1'd0) & (icmp_ln73_fu_408_p2 == 1'd0)) | ((1'b1 == ap_CS_fsm_state8) & (eol_2_i_reg_368 == 1'd0)))) begin
...
always @ (*) begin
    if (((input_stream_TVALID == 1'b1) & (regslice_both_AXI_video_strm_V_data_V_U_ack_in == 1'b1))) begin
...
always @ (*) begin
    if ((((ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_predicate_op65_read_state5 == 1'b1) & (1'b0 == ap_block_pp1_stage0_11001)) | ((input_stream_TVALID_int == 1'b1) & (1'b1 == ap_CS_fsm_state2)) | (~((input_stream_TVALID_int == 1'b0) & (eol_2_i_reg_368 == 1'd0)) & (1'b1 == ap_CS_fsm_state8) & (eol_2_i_reg_368 == 1'd0)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((input_stream_TVALID_int == 1'b1) & (1'b1 == ap_CS_fsm_state2) & (tmp_user_V_fu_388_p1 == 1'd0))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if (((input_stream_TVALID_int == 1'b1) & (tmp_user_V_fu_388_p1 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        ap_ST_fsm_pp1_stage0 : begin
            if (~((1'b0 == ap_block_pp1_stage0_subdone) & (ap_enable_reg_pp1_iter0 == 1'b1) & (icmp_ln73_fu_408_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            end else if (((1'b0 == ap_block_pp1_stage0_subdone) & (ap_enable_reg_pp1_iter0 == 1'b1) & (icmp_ln73_fu_408_p2 == 1'd1))) begin
        ...
        ap_ST_fsm_state8 : begin
            if ((~((input_stream_TVALID_int == 1'b0) & (eol_2_i_reg_368 == 1'd0)) & (1'b1 == ap_CS_fsm_state8) & (eol_2_i_reg_368 == 1'd0))) begin
                ap_NS_fsm = ap_ST_fsm_state8;
            end else if ((~((input_stream_TVALID_int == 1'b0) & (eol_2_i_reg_368 == 1'd0)) & (1'b1 == ap_CS_fsm_state8) & (ap_phi_mux_eol_2_i_phi_fu_371_p4 == 1'd1))) begin
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = (((input_stream_TVALID_int == 1'b0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (ap_predicate_op65_read_state5 == 1'b1)) | ((ap_enable_reg_pp1_iter1 == 1'b1) & (((img_data_stream_2_V_full_n == 1'b0) & (icmp_ln73_reg_496 == 1'd0)) | ((img_data_stream_1_V_full_n == 1'b0) & (icmp_ln73_reg_496 == 1'd0)) | ((img_data_stream_0_V_full_n == 1'b0) & (icmp_ln73_reg_496 == 1'd0)))));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = (((input_stream_TVALID_int == 1'b0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (ap_predicate_op65_read_state5 == 1'b1)) | ((ap_enable_reg_pp1_iter1 == 1'b1) & (((img_data_stream_2_V_full_n == 1'b0) & (icmp_ln73_reg_496 == 1'd0)) | ((img_data_stream_1_V_full_n == 1'b0) & (icmp_ln73_reg_496 == 1'd0)) | ((img_data_stream_0_V_full_n == 1'b0) & (icmp_ln73_reg_496 == 1'd0)))));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = (((input_stream_TVALID_int == 1'b0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (ap_predicate_op65_read_state5 == 1'b1)) | ((ap_enable_reg_pp1_iter1 == 1'b1) & (((img_data_stream_2_V_full_n == 1'b0) & (icmp_ln73_reg_496 == 1'd0)) | ((img_data_stream_1_V_full_n == 1'b0) & (icmp_ln73_reg_496 == 1'd0)) | ((img_data_stream_0_V_full_n == 1'b0) & (icmp_ln73_reg_496 == 1'd0)))));
end
...
always @ (*) begin
    ap_block_state5_pp1_stage0_iter0 = ((input_stream_TVALID_int == 1'b0) & (ap_predicate_op65_read_state5 == 1'b1));
end

always @ (*) begin
    ap_block_state6_pp1_stage0_iter1 = (((img_data_stream_2_V_full_n == 1'b0) & (icmp_ln73_reg_496 == 1'd0)) | ((img_data_stream_1_V_full_n == 1'b0) & (icmp_ln73_reg_496 == 1'd0)) | ((img_data_stream_0_V_full_n == 1'b0) & (icmp_ln73_reg_496 == 1'd0)));
end

always @ (*) begin
    ap_block_state8 = ((input_stream_TVALID_int == 1'b0) & (eol_2_i_reg_368 == 1'd0));
end
...
always @ (*) begin
    ap_predicate_op65_read_state5 = ((or_ln76_fu_422_p2 == 1'd0) & (icmp_ln73_fu_408_p2 == 1'd0));
end
...
assign icmp_ln71_fu_397_p2 = ((t_V_reg_263 == rows_V_reg_457) ? 1'b1 : 1'b0);

assign icmp_ln73_fu_408_p2 = ((t_V_6_reg_296 == cols_V_reg_462) ? 1'b1 : 1'b0);

assign img_cols_V_out_din = img_cols_V_dout;

assign img_data_stream_0_V_din = tmp_reg_509;

assign img_data_stream_1_V_din = tmp_2_reg_514;

assign img_data_stream_2_V_din = tmp_3_reg_519;

assign img_rows_V_out_din = img_rows_V_dout;

assign j_V_fu_413_p2 = (t_V_6_reg_296 + 32'd1);

assign or_ln76_fu_422_p2 = (sof_1_i_fu_172 | ap_phi_mux_eol_0_i_phi_fu_311_p4);

assign start_out = real_start;

assign tmp_fu_428_p1 = ap_phi_mux_p_Val2_s_phi_fu_336_p4[7:0];

assign tmp_user_V_fu_388_p1 = input_stream_TUSER_int;
